...
echo -e "\nTest credentials:"
echo -e "  Alice (admin): alice@hbnb.io / alice1234"
echo -e "  Bob:           bob@hbnb.io / bob1234"
echo -e "  Charlie:       charlie@hbnb.io / charlie1234"
echo -e "  Diana:         diana@hbnb.io / diana1234"
echo -e "  Emma:          emma@hbnb.io / emma1234"
echo -e "\nTo stop servers, run:"
